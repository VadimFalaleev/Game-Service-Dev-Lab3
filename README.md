...
- Следующим делом нужно правильно структурировать файлы в проекте, так как хранить разные типы файлов в одной папке является не совсем верным. Для этого создадим все нужные папки для сортировки. Назовем их _Animations, _AudioFiles, _Materials, _Prefabs, _Scenes, _Scripts и _Textures. Переименуем папку Scripts в _Scripts. Далее все файлы используемых анимаций кладем в первую папку, материалов в третью, и так далее, пока все используемые файлы проекта не будут находиться в своих папках. После этого удалим все папки ассетов, которые мы импортировали - другие файлы их тех папок нам больше не пригодятся. После этого у нас получится проект с правильно структурированными файлами, в папках которых в будущем будет легче ориентироваться.
